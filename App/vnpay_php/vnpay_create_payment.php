...
class vnpay_create_payment extends BaseView
{
    ...
    
    {
        ...
        $vnp_TmnCode = "YNC5764V"; //Mã định danh merchant kết nối (Terminal Id)
        $vnp_HashSecret = "QG6S7ETD00FCRXY0KX31YVNDIZD98ELN"; //Secret key
        $vnp_Url = "https://sandbox.vnpayment.vn/paymentv2/vpcpay.html";
        $vnp_Returnurl = "http://127.0.0.1:8080/App/vnpay_php/vnpay_return.php";
