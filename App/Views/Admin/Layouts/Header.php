...
?>
        ...
        <head>
            ...
            <!-- Custom CSS -->
            <link href="../../../../public/assets/admin/plugins/chartist/dist/chartist.min.css" rel="stylesheet">
            <!-- Custom CSS -->
...
<![endif]-->
        ...
        <body>
                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle waves-effect waves-dark" href="#" id="navbarDropdown"
                                        ...
                                        <img src="../../../../public/assets/admin/images/users/1.jpg" alt="user" class="profile-pic me-2">Markarn Doe
                                    </a>
                            ...
                            <ul id="sidebarnav">
                                ...
                                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                        href="icon-fontawesome.html" aria-expanded="false"><i class="me-3 fa fa-font"
                                            aria-hidden="true"></i><span class="hide-menu">Comment</span></a></li>
            ...
            <!-- All Jquery -->
            <!-- ============================================================== -->
            <script src="../../../../public/assets/admin/plugins/jquery/dist/jquery.min.js"></script>
            <!-- Bootstrap tether Core JavaScript -->
            <script src="../../../../public/assets/admin/plugins/bootstrap/dist/js/bootstrap.bundle.min.js"></script>
            <script src="../../../../public/assets/admin/js/app-style-switcher.js"></script>
            <!--Wave Effects -->
            <script src="../../../../public/assets/admin/js/waves.js"></script>
            <!--Menu sidebar -->
            ...
            <!--flot chart-->
            <script src="../../../../public/assets/admin/plugins/flot/jquery.flot.js"></script>
            <script src="../../../../public/assets/admin/plugins/flot.tooltip/js/jquery.flot.tooltip.min.js"></script>
            <script src="../../../../public/assets/admin/js/pages/dashboards/dashboard1.js"></script>
        </body>
