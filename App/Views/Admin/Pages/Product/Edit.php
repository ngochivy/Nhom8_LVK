                            ...
                            <form class="form-horizontal" action="/admin/products/<?= $data['id'] ?>" method="POST">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file" class="form-control" id="id"  name="id" value="<?= $data['id'] ?>" disabled>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="id">Ngày đăng</label>
                                        <input type="date" class="form-control" id="id"  name="id" value="<?= $data['id'] ?>" disabled>
                                    </div>
                                    <div class="form-group">
