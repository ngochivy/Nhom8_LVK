                            ...
                            <form class="form-horizontal" action="/admin/products/<?= $data['id'] ?>" method="POST">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="price" placeholder="Nhập tên loại sản phẩm..." name="price" value="<?= $data['price'] ?>" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="name">giảm giá*</label>
                                        <input type="text" class="form-control" id="discount_price" placeholder="Nhập tên loại sản phẩm..." name="discount_price" value="<?= $data['discount_price'] ?>" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="name">hình*</label>
                                        <input type="text" class="form-control" id="image" placeholder="Nhập tên loại sản phẩm..." name="image" value="<?= $data['image'] ?>" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="name">ngay đăng*</label>
                                        <input type="text" class="form-control" id="date" placeholder="Nhập tên loại sản phẩm..." name="date" value="<?= $data['date'] ?>" required>
                                    </div>
                                    <div class="form-group">
